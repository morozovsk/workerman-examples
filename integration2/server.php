...
$ws_worker->onConnect = function($connection) use (&$users)
{
    $connection->onWebSocketConnect = function($connection) use (&$users)
    {
        ...
        // вместо get-параметра можно использовать для идентификации пользователя cookies из массива
        // $_COOKIE или даже идентификатор из сессии (для этого нужны дополнительные настройки)
    };
};
